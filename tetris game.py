...
def play():
    ...
    locked_positions = { }  #occupied positions
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:    #key fucntions
        ...
        #drawing the window, grid and piece
        draw_window(window)
...
window=pygame.display.set_mode((w_height, w_width))
